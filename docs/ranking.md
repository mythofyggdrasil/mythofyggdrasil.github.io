...
## O nível e o ranking dos equipamentos

O level é similar ao que já temos no Ragnarok convencional, com as armas de level 1, level 2, level 3 e level 4.

Mas agora temos também level para os demais equipamentos (menos Chapéus e Acessórios). Para consultar o level de seu equipamento, é só ver a descrição dele.
...
| Peça de Equipamento | Bônus Principal |
| :--- | :--- |
...
*   Dois equipamentos **sem estrela** geram um com **uma estrela**.
*   Dois com **uma estrela** geram um com **duas estrelas**.
*   E assim por diante.
...
Para fazer ele, você precisa de:
*   1 Iron Hammer
*   20 Star Cluster
*   50 Spiritual Energy
...
>
> Mesmo usando o Star Hammer, você ainda vai perder os catalisadores e o dinheiro, somente o equipamento sobressalente será salvo.
>
...
Quanto mais estrelas forem modificadas ou adicionadas, mais caro será para alterar seus bônus, como se pode ver no print, 9kk de zenny para liberar o bônus, por isso, completar todas as estrelas deve ser considerado como uma feature end game.
