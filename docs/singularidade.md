...
Todos os monstros que você eliminar durante o jogo, têm a chance de dropar uma pedra que será usada para adicionar singularidade no seu equipamento.
...
E é bem comum o bônus não vir no valor que você quer, mas você tem a opção de rodar a singularidade novamente gastando mais pedras e alterando o valor do bônus recebido.
...
| Group 1              | Valores       | Group 2                  | Valores     |
| :------------------- | :------------ | :----------------------- | :---------- |
...
| ATK                  | 1%\~8%        |                          |             |
| **Group 3**          | **Valores**   | **Group 4**              | **Valores** |
...
# Sistema de encantamento da Carola
